...
public class RecipeController implements ServletContextAware{
	...
	public ModelAndView getRecipeCategoryList() {
	...
	@ResponseBody
	public String recipeRegist(Recipe recipe) {
	...
	@ResponseBody
	public List getRecipeList(int r_category_id, String text) {
	...
	public ModelAndView getDetail(int recipe_id) {
	...
	@ResponseBody
	public String edit(Recipe recipe, String basicRepImg, String[] delBasicRepImg) {
	...
	public String delete(int recipe_id) {
