...
@Controller
public class OrdersController implements ServletContextAware{
	...
	@RequestMapping(value="/admin/orders/detail", method=RequestMethod.GET )
		public ModelAndView getOrderDetail(int orders_id) {
	...
	@ResponseBody
	public String updateListStatus(
	...
	@ResponseBody
	public String updateDetailStatus(Orders orders) {
		//mav는 요청을 유지한다!? 그런데 유지할 필요가 없어서 스트링을 썼다?

		System.out.println("송장번호:"+orders.getInvoice_number());
		System.out.println("아이디:"+orders.getOrders_id());
		System.out.println("상태:"+orders.getOrder_status_id());
